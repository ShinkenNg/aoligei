...
var defaultRenderText = function defaultRenderText(text, valueType, index, item, columnEmptyText) {
  ...
  if (valueType === 'dateRange' && text && Array.isArray(text) && text.length === 2) {
    ...
    return _react.default.createElement("div", null, _react.default.createElement("div", null, startText ? (0, _moment.default)(startText).format('YYYY-MM-DD') : '-'), _react.default.createElement("div", null, endText ? (0, _moment.default)(endText).format('YYYY-MM-DD') : '-'));
  }
  /**
   *如果是日期加时间类型的值
   */
  ...
  if (valueType === 'dateTimeRange' && text && Array.isArray(text) && text.length === 2) {
    ...
    return _react.default.createElement("div", null, _react.default.createElement("div", null, _startText ? (0, _moment.default)(_startText).format('YYYY-MM-DD HH:mm:ss') : '-'), _react.default.createElement("div", null, _endText ? (0, _moment.default)(_endText).format('YYYY-MM-DD HH:mm:ss') : '-'));
  }
  /**
   *如果是时间类型的值
   */
