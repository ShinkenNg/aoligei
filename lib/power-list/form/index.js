...
var _formOption = _interopRequireDefault(require("./form-option"));
...
var FormInputRender = function FormInputRender(props) {
  var item = props.item,
      intl = props.intl,
      form = props.form,
      type = props.type,
  ...
  if (item.renderFormItem) {
    ...
    var defaultRender = function defaultRender(newItem) {
      return _react.default.createElement(FormInputRender, Object.assign({}, _objectSpread(_objectSpread({}, props), {}, {
        item: newItem
      }) || null));
    ...
    return _react.default.cloneElement(dom, _objectSpread(_objectSpread({}, rest), defaultProps));
  }
  ...
  if (!valueType || valueType === 'text') {
    ...
    if (valueEnum) {
      ...
      }, rest, item.formItemProps), (0, _util.parsingValueEnumToArray)((0, _util.ObjToMap)(valueEnum)).map(function (_ref) {
  ...
  if (valueType === 'dateRange') {
    return _react.default.createElement(_datePicker.default.RangePicker, Object.assign({
      placeholder: [intl.formatMessage('tableForm.selectPlaceholder', {
        title: item.title
...
var proFormItemRender = function proFormItemRender(_ref2) {
  var item = _ref2.item,
      intl = _ref2.intl,
  ...
  var key = (0, _util.genColumnKey)(rest.key, dataIndex, index);

  var dom = _react.default.createElement(FormInputRender, {
    item: item,
    type: type,
    intl: intl,
    form: formInstance
  ...
  return _react.default.createElement(_col.default, Object.assign({}, colConfig, {
    key: key
...
var conversionValue = function conversionValue(value, dateFormatter, PowerColumnsMap) {
  ...
  Object.keys(value).forEach(function (key) {
    ...
    if (_moment.default.isMoment(itemValue) && dateFormatter) {
    ...
    if (Array.isArray(itemValue) && itemValue.length === 2 && dateFormatter) {
      if (dateFormatter === 'string') {
        ...
        tmpValue[key] = [(0, _moment.default)(startValue).format(_formatString || 'YYYY-MM-DD HH:mm:ss'), (0, _moment.default)(endValue).format(_formatString || 'YYYY-MM-DD HH:mm:ss')];
        return;
      }
      ...
      if (dateFormatter === 'number') {
        ...
        tmpValue[key] = [(0, _moment.default)(_startValue).valueOf(), (0, _moment.default)(_endValue).valueOf()];
      }
    } // 都没命中，原样返回
...
var getDefaultSearch = function getDefaultSearch(search, intl, isForm) {
  var config = {
    collapseRender: function collapseRender(collapsed) {
      if (collapsed) {
        return _react.default.createElement(_react.default.Fragment, null, intl.getMessage('tableForm.collapsed', '展开'), _react.default.createElement(_icons.DownOutlined, {
          style: {
            marginLeft: '0.5em',
            transition: '0.3s all',
      ...
      return _react.default.createElement(_react.default.Fragment, null, intl.getMessage('tableForm.expand', '收起'), _react.default.createElement(_icons.DownOutlined, {
        style: {
          marginLeft: '0.5em',
          transition: '0.3s all',
          transform: "rotate(".concat(collapsed ? 0 : 0.5, "turn)")
...
var FormSearch = function FormSearch(_ref3) {
  ...
  var formInstanceRef = (0, _react.useRef)();
  ...
  var _useMergeValue = (0, _useMergeValue3.default)(true, {
  ...
  var windowSize = (0, _useMediaAntdQuery.default)();

  var _useState3 = (0, _react.useState)(getSpanConfig(span || 8, windowSize)),
  ...
  (0, _util.useDeepCompareEffect)(function () {
    ...
    counter.powerColumns.forEach(function (item) {
      tempMap[(0, _util.genColumnKey)(item.key, item.dataIndex, item.index) || 'null'] = item;
    });
  ...
  return _react.default.createElement(_configProvider.ConfigConsumer, null, function (_ref5) {
    ...
    return _react.default.createElement("div", {
    ...
    }, _react.default.createElement("div", null, _react.default.createElement(_form.default, Object.assign({}, formConfig, {
      form: form,
      onValuesChange: function onValuesChange() {
        return forceUpdate();
      },
      initialValues: columnsList.reduce(function (pre, item) {
        var key = (0, _util.genColumnKey)(item.key, item.dataIndex, item.index) || '';
      ...
      shouldUpdate: true,
      noStyle: true
    }, _react.default.createElement(_react.default.Fragment, null, domList)), _react.default.createElement(_col.default, Object.assign({}, colConfig, {
      offset: getOffset(domList.length, colSize),
      key: "option",
      className: (0, _classnames.default)("".concat(className, "-option"), _defineProperty({}, "".concat(className, "-form-option"), isForm))
    }), _react.default.createElement(_form.default.Item, {
      label: isForm && ' '
    }, _react.default.createElement(_formOption.default, {
