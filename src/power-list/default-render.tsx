 ...
 * percent: 百分比
 */
export type PowerColumnsValueType =
  | 'money'
  | 'textarea'
  | 'option'
  | 'date'
...
export type PowerColumnsValueObjectType = {
 ...
 */
export type PowerColumnsValueTypeFunction<T> = (
  item: T,
) => PowerColumnsValueType | PowerColumnsValueObjectType;
 ...
 */
const defaultRenderTextByObject = (text: string | number, value: PowerColumnsValueObjectType) => {
